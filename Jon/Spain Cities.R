...
distancias <- read.xlsx("DistanciasCuidades.xlsx", sheetIndex = 1,stringsAsFactors = F)
tiempos <- read.xlsx("TiemposCiudades.xlsx", sheetIndex = 1,stringsAsFactors = F)
fallos <- read.xlsx("ciudadesQueFallan.xlsx", sheetIndex = 1,stringsAsFactors = F)
